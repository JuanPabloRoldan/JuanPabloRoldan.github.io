...
<img src="{{ site.url }}{{ site.baseurl }}/images/research/aerobreakup.svg" class="research-thumb" alt="Planar shock passing over a deforming droplet">
...
<div class="research-card">
<img src="{{ site.url }}{{ site.baseurl }}/images/research/bubbly-droplet.svg" class="research-thumb" alt="Droplet seeded with sub-grid Lagrangian bubbles">
<div class="research-body">
...
<div class="research-card">
<img src="{{ site.url }}{{ site.baseurl }}/images/research/hypersonics.svg" class="research-thumb" alt="Entry capsule with a detached bow shock and separated backshell wake">
<div class="research-body">
...
<div class="research-card">
<img src="{{ site.url }}{{ site.baseurl }}/images/research/rarefied-flow.svg" class="research-thumb" alt="Collisionless molecular trajectories striking and re-emitting from a surface">
<div class="research-body">
...
<div class="research-card">
<img src="{{ site.url }}{{ site.baseurl }}/images/research/reduced-order-modeling.svg" class="research-thumb" alt="Compressor blade cascade with a POD energy spectrum">
<div class="research-body">
...
<div class="research-card">
<img src="{{ site.url }}{{ site.baseurl }}/images/research/heterogeneous-computing.svg" class="research-thumb" alt="A workload split across CPU, GPU, and quantum hardware">
<div class="research-body">
